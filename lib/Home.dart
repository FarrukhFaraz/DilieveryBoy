                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        capitalize('DELIVERD'/*model.activeStatus!*/),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                                " $TOTAL_AMOUNT: " +
                                    getPriceFormat(
                                        context, double.parse('125'/*model.payable!*/))!,
                    ...
                    Expanded(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(" PayPall" /*${model.payMethod!}*/,
                                overflow: TextOverflow.ellipsis,
                                softWrap: true,
                                maxLines: 2),
                          ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(" Order on: 25 Nov, 2021"  /*model.orderDate!*/),
                  ],
                ),
              )
            ])),
        onTap: () async {
          // remove this model and add list here
          Order_Model modell = Order_Model();
          await Navigator.push(
            context,
            CupertinoPageRoute(
                builder: (context) => OrderDetail(model: modell)),
          );
          setState(() {
           // getUserDetail();
          });
